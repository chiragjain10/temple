  ...
  const content = {
    ...
    hi: {
      ...
      booking: {
        ...
        description:
          "श्री अतिशय क्षेत्र पटेरियाजी में अब श्रद्धालु ऑनलाइन माध्यम से राशि भेजकर शांतिधारा बुक कर सकते हैं।",
        ...
        list: [
          ...
          "सर्वसिद्धि विधान",
          "कल्याण मंगल विधान",
          "अन्य विशेष विधि-विधान"
        ],
        footer:
          "ऑनलाइन बुकिंग सुविधा से देश–विदेश में निवासरत श्रद्धालुओं को भी घर बैठे पुण्य लाभ प्राप्त होगा।",
        contact:
          "अधिक जानकारी हेतु क्षेत्र कार्यालय से संपर्क करें।"
      },
      accounts: [
        {
          type: "क्षेत्र विकास हेतु दान",
          name: "श्री पार्श्वनाथ दिगम्बर जैन अतिशय क्षेत्र ट्रस्ट",
          bank: "स्टेट बैंक ऑफ इंडिया",
          acNo: "11316156245",
          ifsc: "SBIN0006138",
          branch: "गढ़ाकोटा"
        },
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {t.accounts.map((acc, index) => (
              <div
                key={index}
                className="bg-white p-8 rounded-xl shadow-md border-t-4 border-[#9a3412] hover:shadow-xl transition"
              >
                <div className="text-xs font-bold text-[#9a3412] mb-2 uppercase tracking-wider">
                  {acc.type}
                </div>

                <p className="font-bold text-[#5c2415] mb-2 text-lg">
                  {acc.name}
                </p>

                <p className="text-sm mb-3 text-gray-600">
                  {acc.bank} {acc.branch && `- ${acc.branch}`}
                </p>

                <p className="font-mono text-[#d97706] font-bold text-lg">
                  {acc.acNo}
                </p>
